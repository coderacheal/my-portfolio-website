...
const projectData = [
  {
    ...
    projectWebsite: '',
    miniIntro: 'No more drunk texting! Sunday is a chat app embed with a NLP transformer model that predicts the sentiment(+ probability) of your text before you shoot yourself in the foot. Again',
    projectSummaryOne: 'Sunday is a chat app embed with a NLP transformer model from huggingface. The app predicts sentiment and the accompaning probability of the sentiment before and allow users to decide if they still want to send the text giving the information.',
    projectSummaryTwo: "Sunday predicts five sentiments Positive, Negative, Neutral, Litigious, Uncertainty. Want to know what your texts convey? Try Sunday. Note that is a pure NLP projects designed and built for eduction and academic purposes",
    builtFor: 'No more drunk texting',
    backgroundImage: everestHero,
    carouselImages: [everest1, everest2, everest3],
